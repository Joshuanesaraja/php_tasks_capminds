...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    /*
     * PHP only receives and trims form input.
     * No date calculations are performed here.
     */
            ...
            if ($validation_status === "INVALID_DOB") {
                ...
                */
                ...
                if (!$stmt) {
                    ...
                    $message = "Database error while registering patient.";
                    $message_type = "danger";
                } else {
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea
                                ...
                                name="address"
                                rows="3"
                                placeholder="Enter patient address"><?= htmlspecialchars($address) ?></textarea>
